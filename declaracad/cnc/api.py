...
with enaml.imports():
    from declaracad.cnc.cutters import (ChamferMill, EndMill, FaceMill, Tool,
                                        TwistDrill)
    ...
    from declaracad.cnc.operations.pocket import (CircularPocket,
                                                  CircularPocketData,
                                                  PocketData, PocketOperation)
