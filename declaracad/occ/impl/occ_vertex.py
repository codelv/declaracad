...
from OCCT.Aspect import (Aspect_TOM_BALL, Aspect_TOM_O, Aspect_TOM_O_PLUS,
                         Aspect_TOM_O_POINT, Aspect_TOM_O_STAR, Aspect_TOM_O_X,
                         Aspect_TOM_PLUS, Aspect_TOM_POINT, Aspect_TOM_RING1,
                         Aspect_TOM_RING2, Aspect_TOM_RING3, Aspect_TOM_STAR,
                         Aspect_TOM_X)
