...
from OCCT.BRepMesh import (BRepMesh_Context, BRepMesh_DelabellaMeshAlgoFactory,
                           BRepMesh_FaceDiscret, BRepMesh_IncrementalMesh)
from OCCT.MeshVS import (MeshVS_DA_BackInteriorColor, MeshVS_DA_BeamColor,
                         MeshVS_DA_BeamType, MeshVS_DA_BeamWidth,
                         MeshVS_DA_ColorReflection, MeshVS_DA_DisplayNodes,
                         MeshVS_DA_EdgeColor, MeshVS_DA_EdgeWidth,
                         MeshVS_DA_InteriorColor, MeshVS_DA_MarkerColor,
                         MeshVS_DA_MarkerScale, MeshVS_DA_MarkerType,
                         MeshVS_DA_ShowEdges, MeshVS_ElementalColorPrsBuilder,
...
from declaracad.occ.mesh import (Element, Node, ProxyElement, ProxyIterator,
                                 ProxyMesh, ProxyMeshTopology, ProxyNode,
                                 Shape)
...
try:
    from SMESH.NETGENPlugin import (NETGENPlugin_NETGEN_2D3D,
...
class OccMesh(OccDependentShape, ProxyMesh):
    ...
    def update_shape(self, change=None):
        ...
        mesh = self.ais_shape = MeshVS_Mesh()
